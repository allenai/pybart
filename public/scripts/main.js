		...
		function displayTree(data, containerId, category) {
            ...
            if (links.length > 0)
            {
                basicTag.links.forEach((e) => {
                    found = false
                    links.forEach((e2) => {
                        if ((e2.arguments[0].anchor.text == e.arguments[0].anchor.text) && (((e.trigger in window) && (e2.trigger in window)) || (e2.trigger.text == e.trigger.text)))
                        {
                            found = true
                    ...
                    {   
                        ...
                        basicTag.links.forEach((e3) => {
                            if ((e != e3) && ((((e3.arguments[0].anchor.text == e.arguments[0].anchor.text) && (((e.trigger in window) && (e3.trigger in window)) || (e3.trigger.text == e.trigger.text)))) || (((e3.arguments[0].anchor.text == e.trigger.text) && (e3.trigger.text == e.arguments[0].anchor.text)))))
                            {
                                e.top = false
                                e.slot = e.slot * -1
                                e.show()
