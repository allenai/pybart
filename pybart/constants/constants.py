...
with open(Path(__file__).parent.__str__() + "/eud_literal_allowed_list_en.json") as f:
    en = json.load(f)

with open(Path(__file__).parent.__str__() + "/eud_literal_allowed_list_he.json") as f:
    he = json.load(f)
